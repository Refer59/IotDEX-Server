...
export const updateAuthUserPassword = catchAsync(async (req, res, next) => {
...
export const deleteAuthUser = catchAsync(async (req, res) => {
...
const filterObject = (object, ...onlyFieldsAllowed) => {
